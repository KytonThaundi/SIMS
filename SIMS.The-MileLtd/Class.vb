...
Public Class Lecturers
    ...
    Private Sub AnnouncementsToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles AnnouncementsToolStripMenuItem.Click
        ...
        If frmHome.lbusertype.Text = "Admin" Then
            ...
            If gpbPostAnnounce.Visible = True Then
                directorystr = "\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\Announcements"
    ...
    Private Sub btnDownload_Click(sender As Object, e As EventArgs) Handles btnDownload.Click
        ...
        Else
            ...
            If (FolderBrowserDialog1.ShowDialog() = DialogResult.OK) Then
                ...
                path = "\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\" + cmbxClassAssign.SelectedValue + "\" + cmbxCourseAssign.SelectedValue + ""
    ...
    Private Sub btnPostAssign_Click(sender As Object, e As EventArgs) Handles btnPostAssign.Click
        ...
        Else
            ...
            Dim di As DirectoryInfo = New DirectoryInfo("\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\" + cmbxClassAssign.SelectedValue + "\" + cmbxCourseAssign.SelectedValue + "")
            Dim FILE_NAME As String = "\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\" + cmbxClassAssign.SelectedValue + "\" + cmbxCourseAssign.SelectedValue + "\" + txtAssgnTittle.Text + ".txt"
            Try
            ...
            If gpbPostAssign.Visible = True Then
                ...
                Else
                    directorystr = "\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\" + cmbxClassAssign.SelectedValue + "\" + cmbxCourseAssign.SelectedValue + ""
                    If Directory.Exists(directorystr) Then
                        ' This path is a directory.
                        Call loadarchivedgv(directorystr)
                    Else
    ...
    Private Sub btnAttachAssign_Click(sender As Object, e As EventArgs) Handles btnAttachAssign.Click
        ...
        Else
            ...
            Dim path As String = "\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\" + cmbxClassAssign.SelectedValue + "\" + cmbxCourseAssign.SelectedValue + ""
    ...
    Private Sub btnSaveAssign_Click(sender As Object, e As EventArgs) Handles btnSaveAssign.Click
        ...
        My.Computer.FileSystem.DeleteFile("\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\" + cmbxClassAssign.SelectedValue + "\" + cmbxCourseAssign.SelectedValue + "\" + formaFile + ".txt")
        Dim FILE_NAME As String = "\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\" + cmbxClassAssign.SelectedValue + "\" + cmbxCourseAssign.SelectedValue + "\" + txtAssgnTittle.Text + ".txt"
        FileOpen(1, FILE_NAME, OpenMode.Output)
        For Each line In txtMessage.Lines
            PrintLine(1, line)
    ...
    Private Sub btnPostAnnounce_Click(sender As Object, e As EventArgs) Handles btnPostAnnounce.Click
        ...
        Else
            ...
            Dim di As DirectoryInfo = New DirectoryInfo("\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\Announcements")
    ...
    Private Sub dgvcompAnnounce_CellContentDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvcompAnnounce.CellContentDoubleClick
        Me.txtCompose.LoadFile("\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\Announcements\" + Me.dgvcompAnnounce.CurrentRow.Cells(0).Value.ToString + ".txt", RichTextBoxStreamType.PlainText)
    ...
    Private Sub btnSaveAnnounce_Click(sender As Object, e As EventArgs) Handles btnSaveAnnounce.Click
        ...
        My.Computer.FileSystem.DeleteFile("\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\Announcements\" + formaFile + ".txt")
        Dim FILE_NAME As String = "\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\Announcements\" + txtCompAnnaunceTittle.Text + ".txt"
        FileOpen(1, FILE_NAME, OpenMode.Output)
        For Each line In txtCompose.Lines
            PrintLine(1, line)
        Next
    ...
    Private Sub dgvAnnouncements_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles dgvAnnouncements.CellDoubleClick
        Me.txtAnnouncement.LoadFile("\\SDE-KYTON\Users\Public\SIMS.The-MileLtd\Announcements\" + Me.dgvAnnouncements.CurrentRow.Cells(0).Value.ToString + ".txt", RichTextBoxStreamType.PlainText)
