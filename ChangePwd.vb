    ...
    Private Sub btnChangePwd_Click(sender As Object, e As EventArgs) Handles btnChangePwd.Click
        ...
        Else
            Try
                ...
                Dim cmd As New SqlCommand("UPDATE dbo.users SET username = '" & txtCPUname.Text & "', password= '" & txtCPPword.Text & "',usertyp = '" & frmHome.lbusertype.Text & "' WHERE username = '" & Login.txtUname.Text & "'And  password= '" & Login.txtPword.Text & "'", conn)
                ...
                If (cmd.ExecuteNonQuery().Equals(1)) Then
                    ...
                    Try
                        ...
                        Dim cmd1 As SqlCommand = New SqlCommand(theQuery2, conn)
